...
def show_practice_trial(index):
    ...
    canvas.create_text(
        screen_width // 2, 75,
        text="Practice: Click on the image that is most different from the other two.\n"
             "Entraînement : Cliquez sur l'image la plus différente des deux autres.",
